...
\par{
  ...
  Email: $if(email)$\href{mailto:$email$}{$email$}$else$ $endif$\\
  Website: $if(website)$\href{$website$}{$website$}$else$ $endif$\\
  Github: $if(github)$\href{$github$}{$github$}$else$ $endif$\\
  LinkedIn: $if(linkedin)$\href{$linkedin$}{$linkedin$}$else$ $endif$\\
...
\titleformat{\paragraph}{\itshape}{}{0em}{\underline}
